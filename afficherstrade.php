  ...
  <section id="container">
    ...
    <section id="main-content">
      ...
      <center>
       ...
       <form action = "afficherStrade.php" method = "GET">
        <h4>Rechercher 
...
<br>
       ...
       <button type="submit" name="Imprimer" value="Imprimer" class="btn btn-danger">Imprimer</button>
           ...
           <br>
            <?php if (!empty($list)) { ?>
            <a href="trierSd.php?Name=<?php echo $terme_trouve["nom"]; ?>">
                <input class="btn btn-danger" type="button" value="Tri Descendant">
              </a>
                <a href="triers.php?Name=<?php echo $terme_trouve["nom"]; ?>">

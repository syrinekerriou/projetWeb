...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  ...
  $select_terme = $bdd->prepare("SELECT * FROM theme WHERE nomt LIKE ? OR prix LIKE ?");
...
{
  $select_terme = $bdd->prepare("SELECT * FROM theme ");
...
<center>
       ...
       <form action = "affichertheme.php" method = "GET">
        <h4>Rechercher 
    ...
    <button type="submit" name="s" value="Rechercher" class="btn btn-danger">chercher</button>
          ...
          <center>
            <h1 nomt="bri"><strong>la listes des themes</strong></h1>
                   <br nomt="y" />
          ...
          <div class="container">
            <div class="row">
             <form name="f1"  method="POST" action="pdfTh.php" onSubmit="return verif()" >
                  ...
                  while($terme_trouve = $select_terme->fetch())
  {
      ?>  <div class="element" id="columns" >
                      ...
                      <tr>
                        <th scope="row"><?php echo $terme_trouve['nomt']; ?></th>
...
<br>
        ...
        <td><button type="submit" name="Imprimer" value="Imprimer" class="btn btn-danger">Imprimer</button></td>
            ...
            <?php if (!empty($list)) { ?>
             <a href="trierThd.php?Name=<?php echo $terme_trouve["nomt"]; ?>">
                <input class="btn btn-danger" type="button" value="Tri Descendant"> </a>
                <a href="trierTh.php?Name=<?php echo $terme_trouve["nomt"]; ?>">

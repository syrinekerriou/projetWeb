      ...
      <section class="wrapper">
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <h3>Modifier strade</h3>
<form method="POST" action="modifierS.php">
<div>
    <label class="control-label">nom</label>
    <div class="controls">
    <input class="controle" type="text" name="nom" required pattern="[a-zA-Z-\.]{3,12}" placeholder="saisir le nom strade">
    </div>
    <p>
</div>
...
<div>
     <p>
       <label for="pays" value="choisir le type de strade">saisir le type de strade </label><br />

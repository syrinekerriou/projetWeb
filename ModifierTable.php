...
<form method="POST" action="modifierT.php">
<div>
    <label class="control-label">nom</label>
    <div class="controls">
    <input class="controle" type="text" name="nomtt" required pattern="[a-zA-Z-\.]{3,12}" placeholder="saisir le nom Decoration">
    </div>
    <p>
</div>
<div>
...
<div>
     <p>
       <label for="control-label" value="choisir le type de Decoration">saisir le type strade </label><br />

          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="index.html#">
                  <div class="task-info">
                    <div class="desc">MONALIZA Admin Panel</div>
      ...
      <section class="wrapper">
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <h3>Supprimer theme</h3>
<form method="POST" action="supprimerTH.php">
<div>
    <label class="control-label">nom</label>
    <div class="controls">
    <input class="controle" type="text" name="nomt" required pattern="[a-zA-Z-\.]{3,12}" placeholder="saisir le nom strade">
    </div>
    <p>
</div>

...
?>
          <form method="POST" action="affichertable.php">
            <input type="text" nomtt="arearech" name="search" placeholder="Taper pour rechercher ... " required>
          ...
          <div class="container">
                ...
                <tbody>
                  ...
                  if (!empty($list)) {
                    foreach ($list as $p) {
                      ...
                      <tr>
                        <th scope="row"><?php echo $p['nomtt']; ?></th>
                       ...
                       <td><a href="supprimerTable.php?nomtt=<?php echo $p["nomtt"];  ?>">
            ...
            <?php if (!empty($list)) { ?>
              <a href="trierTd.php?Name=<?php echo $p["nomtt"]; ?>">
                <input class="btn btn-danger" type="button" value="Tri Descendant">
              </a>
                <a href="trierT.php?Name=<?php echo $p["nomtt"]; ?>">

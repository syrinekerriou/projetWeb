...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo"><b>MONA<span>LIZA</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="deco.php">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
      ...
      <section class="wrapper">
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <h3>Ajouter strade</h3>
<form method="POST" action="AjoutS.php">
<div>
    <label class="control-label">nom</label>
    <div class="controls">
    <input class="controle" type="text" name="nom" required pattern="[a-zA-Z-\.]{3,12}" placeholder="saisir le nom Decoration">
    </div>
    <p>
</div>
<div>
    ...
    <div class="controls">
    <textarea rows="4" cols="50" type="text" name="description" placeholder="Description" required pattern="[A-Za-z].{4,}"></textarea>
    </div>
    <p>
</div>
<div>
    ...
    <div class="controls">
    <input name="quantite" type="number" required pattern="[0-9]" x-moz-errormessage="La quantite doix etre des chiffres" placeholder="Quantite">
    </div>
    <p>
</div>
<div>
     <p>
       <label for="pays" value="choisir le type de Decoration">saisir le type strade </label><br />
       <select name="type" id="type">
           <option value="france">anniversaire </option>
           <option value="espagne">marriage</option>
           <option value="italie">seminaire</option>
       </select>
   </p>
    </div>
  <div>

      ...
      <section class="wrapper">
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <h3>Supprimer table</h3>
<form method="POST" action="supprimerT.php">
<div>
    <label class="control-label">nom</label>
    <div class="controls">
    <input class="controle" type="text" name="nomtt" required pattern="[a-zA-Z-\.]{3,12}" placeholder="saisir le nom strade">
    </div>
    <p>
</div>
